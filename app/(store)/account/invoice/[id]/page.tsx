  ...
  if (loading) {
    return (
      <main className="min-h-screen flex items-center justify-center">
        <i className="ri-loader-4-line animate-spin text-3xl text-[#B8860B]" />
      </main>
    );
  }
  ...
  if (error || !order) {
    return (
      <main className="min-h-screen flex flex-col items-center justify-center px-4 text-center">
        ...
        <Link href="/account?tab=orders" className="text-[#B8860B] font-semibold">
          Back to orders
        </Link>
      </main>
    );
      ...
      <div className="max-w-3xl mx-auto">
        <div className="flex items-center justify-between mb-8 print:hidden">
          ...
          <button
            ...
            className="px-4 py-2 bg-[#050505] text-white rounded-lg font-semibold"
          >
            Print / Save PDF
          </button>
        </div>
        ...
        <div className="border border-gray-200 rounded-xl p-8 print:border-0 print:p-0">
          <div className="flex items-start justify-between gap-4 mb-8">
            <div>
              <p className="text-2xl font-bold tracking-wide text-[#050505]">Rayma Kitchenware</p>
              <p className="text-sm text-gray-600">Premium kitchen appliances &amp; kitchenware</p>
            </div>
