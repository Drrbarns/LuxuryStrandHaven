    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-amber-50 flex items-center justify-center px-4">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-8 mb-8 shadow-sm">
          ...
          {timeLeft !== null && !ended ? (
            <div className="flex items-center justify-center gap-4 sm:gap-6 text-gray-900">
        ...
        <div className="grid sm:grid-cols-3 gap-4 sm:gap-6 mb-8">
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-6">
            ...
            <p className="text-gray-600 text-sm">New functionality for a better experience</p>
          </div>
        </div>
